            ...
            <div className='max-w-[1440px] h-full m-auto py-40 relative'>
                ...
                <div className=''>
                    <div className='grid grid-cols-2 gap-5'>
                        <div className='p-10 border rounded-[20px] flex flex-col gap-4'>
                    ...
                    <div className='flex flex-row w-full gap-5 mt-5'>
                        ...
                        <a href='#contact' className='p-10 border rounded-[20px] bg-[#4E4E4E] hover:cursor-pointer hover:bg-[#666666] duration-200 flex flex-col gap-4'>
                            <div>
